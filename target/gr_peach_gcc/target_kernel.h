 ...
 * 
 *  $Id: target_kernel.h 544 2018-11-19 15:39:12Z ertl-hiro $
 */
 ...
 *
 *  タイムウィンドウの長さに指定できる値の上限は，タイムウィンドウタイ
 *  マに設定できる最大値に一致する．
 *
 ...
 *  する．
 *		(TMAX_TWDTIM * 33 + TMAX_TWDTIM / 3 + 1) + 34 < 2^32
 */
#define TMAX_TWDTIM		128849017U
